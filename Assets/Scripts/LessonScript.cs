...
public class LessonScript : MonoBehaviour
{
    ...
    private void LoadImage()
    {
        ...
        Sprite sprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Sprites/Lesson/Banners/" + bannerName + ".png", typeof(Sprite));
    ...
    private void LoadAudio()
    {
        ...
        string audioName = GameManager.GetAudioName(ageIdx);
        AudioClip audioClip = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Audio/" + audioName + ".mp3", typeof(AudioClip));
